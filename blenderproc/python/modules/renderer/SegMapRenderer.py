...
from blenderproc.python.modules.renderer.RendererInterface import RendererInterface
from blenderproc.python.utility.BlenderUtility import load_image, get_all_mesh_objects
                        ...
                        if current_attribute == "instance":
                            ...
                            for object_id in used_object_ids:
                                ...
                                # if the current object has a custom property with that name -> get it
                                    ...
                                    # it throws an exceptionclass_inst_col_map
